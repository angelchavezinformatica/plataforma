            ...
            content:
                <div className="flex flex-col pr-5 pl-5">
                        ...
                        <form className="space-y-7 mt-2">
                            <div className="flex space-x-4">
                                <div className="w-full">
                                    ...
                                    <input id="titulo" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                        placeholder=""
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex space-x-4">
                                <div className="w-1/2">
                                    ...
                                    <input id="academica" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                        placeholder="Desarrollo de software, diseño UX/UI, marketing, etc."
                                    />
                                </div>
                                <div className="w-1/2">
                                    <label htmlFor="modalidad" className="block text-sm font-bold">
                                        Modalidad del trabajo
                                    </label>
                                    <input id="modalidad" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                            ...
                            <div className="flex space-x-4">
                                <div className="w-full">
                                    ...
                                    <textarea id='descripcion' rows={4} className='w-full bg-[#20274D26] rounded px-3 py-2' >
                            ...
                            <div className="flex space-x-4">
                                <div className="w-1/2">
                                    ...
                                    <input id="tiempo" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                ...
                                <div className="w-1/2">
                                    ...
                                    <input id="duracion" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                    ...
                    <div className="flex justify-end items-center mt-8 pr-4">
                        ...
                        <Button className="flex items-center bg-[#20274D] hover:bg-[#4C1D95]/90 text-white gap-2 py-4"
                        ...
                        <form className="space-y-7 mt-2">
                            <div className="flex space-x-4">
                                <div className="w-1/2 space-y-2">
                                    <label htmlFor="aptitudes" className="block text-sm font-bold">
                                        Aptitudes asociadas al empleo*                           
                                    </label>
                                    <input id="aptitudes" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                        placeholder="Desarrollo de software, diseño UX/UI, marketing, etc."
                                    />
                                    <div className="p-1 rounded-lg space-x-2 space-y-2">
                                        ...
                                        <div className="inline-flex items-center justify-between bg-[#20274D] p-3 rounded-lg shadow space-x-2">
                                            <span className="text-[#ffffff] font-medium text-[12px]">Texto dinámico 1</span>
                                            <XIcon className="h-4 w-4 text-gray-500 cursor-pointer hover:text-red-500" />
                                        </div>

                                        {/* Div hijo 2 */}
                                        <div className="inline-flex items-center justify-between bg-[#20274D] p-3 rounded-lg shadow space-x-2">
                                            <span className="text-[#ffffff] font-medium text-[12px] ">Texto mucho más largo que el anterior</span>
                                            <XIcon className="h-4 w-4 text-gray-500 cursor-pointer hover:text-red-500" />
                                        </div>

                                        {/* Div hijo 3 */}
                                        <div className="inline-flex items-center justify-between bg-[#20274D] p-3 rounded-lg shadow space-x-2">
                                            <span className="text-[#ffffff] font-medium text-[12px] ">Texto</span>
                                            <XIcon className="h-4 w-4 text-gray-500 cursor-pointer hover:text-red-500" />
                                        </div>
                                ...
                                <div className="w-1/2 space-y-2">
                                    <label htmlFor="tecnologias" className="block text-sm font-bold">
                                        Tecnologías y herramientas específicas*
                                    </label>
                                    <input id="tecnologias" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                        placeholder="Remoto, híbrido o presencial"
                                    />
                                    <div className="p-1 rounded-lg space-x-2 space-y-2">
                                        {/* Div hijo 1 */}
                            ...
                            <div className="flex space-x-4">
                                <div className="w-full space-y-2">
                                    <label htmlFor="requisitos" className="block text-sm font-bold">
                                        Requisitos y calificaciones*                        
                                    </label>

                                    <textarea id='requisitos' rows={4} className='w-full bg-[#20274D26] rounded px-3 py-2' >
                            ...
                            <div className="flex space-x-4">
                                <div className="w-1/2 space-y-2">
                                    ...
                                    <input id="idioma" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                        placeholder="Inglés, Francés, etc."
                                    />
                                </div>
                                <div className="w-1/2 space-y-2">
                                    <label htmlFor="tipo_colaboracion" className="block text-sm font-bold">
                                        Tipo de colaboración*
                                    </label>
                                    <input id="tipo_colaboracion" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
            ...
            content: (
                ...
                <div className="mt-4 p-4 border rounded shadow-md">
                    <form className="space-y-4 mt-2">
                        <div className="flex space-x-4">
                            <div className="w-full space-y-2">
                                <label htmlFor="responsabilidades" className="block text-sm font-bold">
                                    Responsabilidades y atribuciones*                          
                                </label>

                                <textarea id='responsabilidades' rows={4} className='w-full bg-[#20274D26] rounded px-3 py-2' 
                        ...
                        <div className="flex space-x-4">
                            <div className="w-1/2 space-y-2">
                                <label htmlFor="beneficios" className="block text-sm font-bold">
                                    Beneficios Adicionales                         
                                </label>

                                <textarea id='beneficios' rows={4} className='w-full bg-[#20274D26] rounded px-3 py-2' 
                            ...
                            <div className="w-1/2 space-y-2">
                                ...
                                <textarea id='etapas' rows={4} className='w-full bg-[#20274D26] rounded px-3 py-2' 
                        ...
                        <div className="flex space-x-4">
                            <div className="w-full space-y-2">
                                ...
                                <textarea id='requisitos' rows={2} className='w-full bg-[#20274D26] rounded px-3 py-2' 
                                 placeholder='Tareas específicas y funciones del rol.'   >
                        ...
                        <div className="flex space-x-4">
                            <div className="w-1/2">
                                ...
                                <input id="rango" type="text" className="w-full bg-[#20274D26] rounded px-3 py-2"
                            ...
                            <div className="w-1/2">
                                ...
                                <input id="plazo" type="date" className="w-full bg-[#20274D26] rounded px-3 py-2"
                                    placeholder=""
                                />
                            </div>
                        </div>
            ...
            <div className="p-4">
                <div className="flex items-center justify-between">
                    <div className="flex gap-4 items-center">
                        <span className="text-[#20274D] text-[24px] font-medium">Crear proyecto</span>
                        <span className="text-[#003D91] text-[20px] ">Conecta con los mejores candidatos en tiempo récord</span>
                    </div>
