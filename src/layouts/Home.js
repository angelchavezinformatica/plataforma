...
export default function Home() {
  ...
  return (
    <>
        <div className="flex flex-col min-h-screen bg-[#5145C6]">
            ...
            <nav className="flex justify-between items-center px-8 py-4">
                ...
                <div className="space-x-8">
                    ...
                    <Link to="/login" className="bg-[#20274D] text-[#FFFFFF] pt-3 pb-3 pr-5 pl-5 rounded-[17px] w-[196px] text-[20px] ">
                        Iniciar Sesión
                    </Link>
                </div>
            </nav>
            ...
            <div className="flex items-center justify-center flex-grow">
                <div className="text-center">
                    ...
                    <div className='flex items-center justify-center space-x-4 m-4'>
                        ...
                        <button className="botones w-[169px] flex items-center justify-between px-4 py-2 rounded-md bg-white border border-gray-300">
                            <span className="w-3 h-3 bg-[rgba(19,192,191,1)] rounded-sm"></span>
                        ...
                        <button className="botones w-[575px] flex items-center justify-between px-4 py-2 rounded-md bg-white border border-gray-300">
                            <span className="w-3 h-3 bg-[rgba(19,192,191,1)] rounded-sm"></span>
                            <span>Search</span>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-600" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
        ...
        {/* listo */}
        <div className="flex flex-col items-center justify-center p-10 flex-grow space-y-5">
            ...
            <Link to="/register" className='block w-[200px] text-center text-[25px] bg-[#20274D] p-4 text-[#FFFFFF] rounded-[17px]' >
                    Registrarse
            </Link>
