    ...
    const steps = [
        {
            ...
            content:
                <div className="flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-lg text-gray-700">Validación completada con éxito.</p>
                    <button onClick={() => setActiveStep((prev) => (prev < steps.length - 1 ? prev + 1 : prev))}  
                    ...
                    <div className="flex-1 p-4  text-green-800 rounded-lg shadow-md">
                        <form className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="nombre" className="block text-sm font-medium text-green-800">
                                        Nombre:
                                    </label>
                                ...
                                <div>
                                    <label htmlFor="apellido" className="block text-sm font-medium text-green-800">
                                        Apellido:
                                    </label>
                                    <input
                                        id="apellido"
                            ...
                            <div>
                                <label htmlFor="profesion" className="block text-sm font-medium text-green-800">
                                    Profesión:
                                </label>
                                <input id="profesion" name="profesion" type="text" placeholder="Profesión"
                                className="mt-1  p-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500"
                                />
                            </div>
                            ...
                            <div>
                                <label htmlFor="empresa" className="block text-sm font-medium text-green-800">
                            ...
                            <div>
                                <label htmlFor="ruc" className="block text-sm font-medium text-green-800">
                                RUC o razón social:
                                </label>
                                <input
                                id="ruc"
                            ...
                            <div>
                                <label htmlFor="cargo" className="block text-sm font-medium text-green-800">
                                Cargo o rol:
                                </label>
                                <input
                                id="cargo"
                            ...
                            <div>
                                <label htmlFor="ubicacion" className="block text-sm font-medium text-green-800">
                                Ubicación:
                                </label>
                                <input
                                id="ubicacion"
            ...
            content: (
                ...
                <div className="flex flex-col justify-between h-full pb-4">
                    ...
                    <div className="space-y-6">
                        ...
                        {!showForm && (
                            <Button variant="outline" className="flex items-center gap-2 bg-white border-2 border-[#3C137B] text-[#3C137B] hover:bg-primary/10 py-4"
                            onClick={toggleForm} >
                        ...
                        <div className="mt-4 p-4 border rounded shadow-md">
                            <form className="space-y-7">
                                <div className="flex space-x-4">
                                    <div className="w-1/2">
                                        <label htmlFor="cargo" className="block text-sm font-bold">
                                            Cargo                              
                                        </label>
                                        <input id="cargo" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                            placeholder="Ejemplo: Lider de proyectos"
                                        />
                                    </div>
                                    <div className="w-1/2">
                                        <label htmlFor="empleo" className="block text-sm font-bold">
                                            Tipo de empleo
                                        </label>
                                        <input id="empleo" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                ...
                                <div className="flex space-x-4">
                                    <div className="w-1/2">
                                        <label htmlFor="empresa" className="block text-sm font-bold">
                                            Nombre de la empresa                              
                                        </label>
                                        <input id="empresa" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                            placeholder="Ejemplo: Microsoft"
                                        />
                                    </div>
                                    <div className="w-1/2">
                                        <label htmlFor="ubicacion" className="block text-sm font-bold">
                                            Ubicación
                                        </label>
                                        <input id="ubicacion" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                ...
                                <div className="flex space-x-4">
                                    <div className="w-1/2">
                                        <label htmlFor="fecha_inicio" className="block text-sm font-bold">
                                            Fecha de inicio                            
                                        </label>
                                        <input id="fecha_inicio" type="date" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                            placeholder="Ejemplo: Microsoft"
                                        />
                                    </div>
                                    <div className="w-1/2">
                                        <label htmlFor="fecha_final" className="block text-sm font-bold">
                                            Fecha de Finalizacion
                                        </label>
                                        <input id="fecha_final" type="date" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                            placeholder="Ejemplo: Trujillo - Perú"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex space-x-4">
                                    <div className="w-full">
                                        <label htmlFor="descripcion" className="block text-sm font-bold">
                                            Descripcion                          
                                        </label>

                                        <textarea id='descripcion' className='w-full border-2 border-[#20274D] rounded px-3 py-2' >
                                ...
                                <div className="flex justify-end gap-4">
                                    ...
                                    <Button type="submit" className="bg-[#3C137B] text-white px-4 py-2 rounded">
                                        Guardar
                                    </Button>
                    ...
                    <div className="flex justify-between items-center mt-8 pr-4">
                        <Button variant="ghost" className="text-white hover:text-primary hover:bg-primary/10 py-4">
                            Omitir
                        </Button>
                        <Button className="flex items-center bg-[#4C1D95] hover:bg-[#4C1D95]/90 text-white gap-2 py-4"
...

        {
            ...
            content: (
                ...
                <div className="space-y-6">
                    ...
                    {/* Botón "Añadir experiencia" (oculto si el formulario está visible) */}
                    {!showForm && (
                        <Button variant="outline" className="flex items-center bg-white border-2 border-[#3C137B] gap-2 
                    ...
                    <div className="mt-4 p-4 border rounded shadow-md">
                        <form className="space-y-7">
                            <div className="flex space-x-4">
                                <div className="w-1/2">
                                    <label htmlFor="estudios" className="block text-sm font-bold">
                                        Institucion Educativa                              
                                    </label>
                                    <input id="estudios" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                                        placeholder="Ejemplo: IDAT"
                                    />
                                </div>
                                <div className="w-1/2">
                                    <label htmlFor="grados" className="block text-sm font-bold">
                                        Titulo
                                    </label>
                                    <input id="grado" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
                            ...
                            <div className="flex space-x-4">
                                <div className="w-1/2">
                                    <label htmlFor="academica" className="block text-sm font-bold">
                                        Disciplina académica                              
                                    </label>
                                    <input id="academica" type="text" className="w-full border-2 border-[#20274D] rounded px-3 py-2"
  ...
  return (
    <div className="bg-[#FFFFFF] h-screen pl-6 pd-6 rounded-lg shadow-lg flex flex-col">
        ...
        <div className="flex  space-x-4 flex-1 ">
            ...
            <div className={`p-4 w-1/4 rounded-lg flex flex-col items-start relative ${activeStep === steps.length - 1 ? 'hidden' : ''}`}>
                <div className="flex flex-col space-y-[50px] pt-6">
                    ...
                    >
                        ...
                        <span className={`text-xl ${activeStep === index ? "text-[#393939] font-semibold" : "text-[#393939B2]  "}`}>
                            {step.title}
                        </span>
                        </div>
                    </div>
        ...
        {/* Div hijo derecho que muestra el contenido del paso actual */}
            <div className={`rounded-lg flex flex-col ${activeStep === steps.length - 1 ? 'w-full' : 'w-3/4'}`}>
