...
export default function Home() {
  //   const [, setActivePage] = useState("Mis Proyectos");
      ...
      <div className="flex flex-col h-screen">
        <nav className="flex justify-between items-center px-8 py-1">
          <div className="space-x-8 flex items-center justify-center">
            <p className="text-[30px] text-[#20274D] font-bold">
              ConnectTalent
            </p>
            <p className="text-[20px] text-[#434247] font-bold">Proyectos</p>
            <p className="text-[20px] text-[#434247] font-bold">
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 py-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="space-y-1">
                  ...
                  <p>
                    Este proyecto tiene como objetivo desarrollar una aplicación
                    móvil de gestión <br></br>
                    de tareas que permita a los usuarios organizar su día a día
                    de forma sencilla e <br></br>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      6 meses, con posibilidad de extensión para mantenimiento y
                      actualizaciones.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-600">
                        ...
                        <li>
                          • Familiaridad con patrones de diseño de aplicaciones
                          móviles.
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-600">
                        ...
                        <li>
                          • Herramientas: Firebase, Git, API de Google Calendar
                        </li>
                      </ul>
                    </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-gray-600 ml-4">
                            • Definición de requerimientos y diseño de UI/UX (1
                            mes).
                          </p>
                        </div>
                        <div>
