...
export default function Footer() {
  return (
    <footer className="bg-[#20274D] text-white py-12 px-4">
        <div className="max-w-6xl mx-auto ">
            <div className="flex justify-between  ">
                ...
                <div className="">
                    ...
                    <p className="mb-4">Ingresa tu email para recibir notificaciones sobre <br></br> nuestras novedades.</p>
                    <form className="flex">
                    <input
                        type="email" 
                        placeholder="Email" 
                        className="rounded-r-none text-[#000000] w-full p-1 "
                    />
                    </form>
                    <p className="text-[10px] mt-6" >© 2024 ConnectTalen. Todos los derechos reservados.</p>
                </div>
            </div>
            <div className="mt-12 pt-8 border-t border-navy-800 flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
                <h2 className="text-2xl font-bold">ConnectTalent</h2>
            </div>
            <nav className="mb-4 md:mb-0">
                <ul className="flex space-x-4">
                <li><a href="#" className="hover:underline">Inicio</a></li>
                <li><a href="#" className="hover:underline">Proyectos</a></li>
                <li><a href="#" className="hover:underline">Talentos</a></li>
