        ...
        <aside className="sidebar shadow-2xl">
          ...
          <ul className="sidebar-links">
            ...
            <li onClick={() => handleMenuClick("Tareas")}>
              <a href="#">
                <span className="material-symbols-outlined"> task </span>Tareas
              </a>
            </li>
                      ...
                      {mensajes.map((mensaje) => (
                        ...
                        >
                          ...
                          <div className="ml-4 flex-1">
                            <p className="text-sm">
                              <span className="font-bold">{mensaje.name}</span>{" "}
                              <br></br>
                ...
                <div className="flex-grow">
                  <div className="flex flex-col h-screen ">
                    ...
                    <div className="p-4 rounded-md mb-4 text-[#0000000] h-full  flex justify-end ">
                      <p>
                        ¡Felicitaciones y bienvenido al equipo! Estamos muy{" "}
                        <br></br>
                        emocionados de contar con tu talento y energía.{" "}
                        <br></br>
                        Estamos seguros de que tu experiencia y habilidades{" "}
                        <br></br>
                        serán una gran adición a nuestro equipo. ¡Esperamos{" "}
                        <br></br>
                    ...
                    <form
                      className="flex items-center gap-2 w-full  p-2 bg-white rounded-lg border"
              ...
              <div className="flex">
                        ...
                        >
                          ...
                          <div className="ml-4 flex-1">
                            <p className="text-sm">
                              ...
                              ha postulado al proyecto <br></br>
                              <span className="font-semibold">
                ...
                <div className="flex-grow">
                  <div className="bg-[#7A61D733] flex p-6 justify-between">
                    <div className="">
                      <h1 className="text-[30px] text-[#20274D] ">
                        Desarrollo de una App Movil
                      </h1>
                      <p className="text-[#434247]  ">
                        Name postulo a este proyecto
                      </p>
                    </div>
                      ...
                      <form className="space-y-6">
                        ...
                        <div>
                          <label className="block text-gray-700 font-medium mb-2">
                            ¿Cuántos años de experiencia tienes con Flutter y/o
                            React Native?
                          </label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-gray-700 font-medium mb-2">
                            ¿Qué nivel de experiencia tienes integrando APIs
                            RESTful?
                          </label>
                          <select className="w-full p-1 border-2 border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                          <label className="block text-gray-700 font-medium mb-2">
                            ¿Cuál es tu nivel de familiaridad con patrones de
                        ...
                        <div>
                          ...
                          <select className="w-full p-1 border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
                            <option>Principiante</option>
                            <option>Intermedio</option>
                            <option>Avanzado</option>
                          </select>
                ...
                <div className=" w-[800px] ">
                  ...
                  <div className="w-full max-w-6xl mx-auto p-4 md:p-6  rounded-lg shadow-sm text-sm">
                    <div className="flex items-center justify-between mb-6">
                      ...
                      <button
                        onClick={() => handleMenuClick("Asignar")}
                        size="icon"
                        style={{
                ...
                <div className="bg-[#ffffff] flex-grow flex flex-col items-center  p-2">
                  ...
                  <div className="max-w-md mx-auto mt-2 p-6 bg-white shadow-md rounded-lg space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <select className=" w-[172px] p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500">
                    ...
                    <div>
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <p className="text-sm text-gray-700">
                          <strong>Asignaste a</strong>{" "}
                          <span className="text-blue-500">@worker</span>
                        </p>
                      </div>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-700">
                            ¡Gran avance, Sebastián! Me gusta cómo está quedando
                            la integración del formulario de tareas. ¿Crees que
                            podrías agregar una validación adicional para evitar
                            que los usuarios creen tareas sin un título o fecha
                            límite? Si necesitas más detalles, házmelo saber.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="p-2 grid grid-cols-3 gap-2 ">
                  ...
                  <div className="flex items-center space-x-2 p-2">
                    <input
                      ...
                      className="scale-150 mr-2"
                    />
                    <label htmlFor="prioridadd">
                      Enviar recordatorio automático un día antes del
                      vencimiento
                    </label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2  p-2">
                    ...
                    />
                    <label htmlFor="prioridadd">
                      Bloquear tareas dependientes hasta que esta tarea se
                      complete
                    </label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2  p-2">
                    ...
                    />
                    <label htmlFor="prioridadd">
                      Repetir si no se completa antes de la fecha límite
                    </label>
                  </div>
                  ...
                  <div className="flex items-center space-x-2  p-2">
                    ...
                    />
                    <label htmlFor="prioridadd">
                      Requiere aprobación del administrador al completar
                    </label>
                  </div>
                </div>
