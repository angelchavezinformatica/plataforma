...
import { Archive, Badge, BarChart3, Edit, GraduationCap, HomeIcon, LayoutGrid, List, Megaphone, Package, Palette, Plus, ShoppingCart, Smartphone, Utensils, Zap } from 'lucide-react';
                        ...
                        <div className=' w-[800px] '>
                            ...
                            <div className="w-full max-w-6xl mx-auto p-4 md:p-6  rounded-lg shadow-sm text-sm">
                                <div className="flex items-center justify-between mb-6" >
                                    ...
                                    <button size="icon" style={{ backgroundColor: '#3C137B', color: '#ffffff', border: 'none', padding: '10px' }} >
