  ...
  return (
    <>
      <div className="flex flex-col min-h-screen bg-[#5145C6]">
        ...
        <nav className="flex justify-between items-center px-8 py-4">
          ...
          <div className="space-x-8">
            ...
            <Link
              to="/login"
              className="bg-[#20274D] text-[#FFFFFF] pt-3 pb-3 pr-5 pl-5 rounded-[17px] w-[196px] text-[20px] "
            >
              Iniciar Sesión
            </Link>
          </div>
      ...
      <div className="flex flex-col items-center justify-center p-10 flex-grow space-y-5">
        ...
        <Link
          to="/register"
          className="block w-[200px] text-center text-[25px] bg-[#20274D] p-4 text-[#FFFFFF] rounded-[17px]"
        >
          Registrarse
        </Link>
      </div>
