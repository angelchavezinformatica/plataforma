...
import {FaEnvelope, FaFacebookF, FaGoogle, FaLinkedinIn,FaLock, FaVoicemail, FaUser, } from "react-icons/fa"; // Asegúrate de tener esta línea
          ...
          <form className="w-full max-w-sm space-y-6">
            <div className="mb-4 ">
              <div className="flex items-center border rounded-lg bg-[#F4F8F7]">
                ...
                <input type="text" id="nombre" placeholder="Nombre" className="bg-[#F4F8F7] text-[] w-full px-3 py-2 border-0 focus:outline-none"required/>
              </div>
            </div>
            ...
            <div className="mb-4 ">
              <div className="flex items-center border rounded-lg bg-[#F4F8F7]">
                ...
                <input type="text" id="apellido" placeholder="Apellido" className="bg-[#F4F8F7] text-[] w-full px-3 py-2 border-0 focus:outline-none" required/>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center bg-[#F4F8F7] border rounded-lg">
                ...
                <input type="email" id="email" placeholder="Email" className="w-full bg-[#F4F8F7] px-3 py-2 border-0 focus:outline-none" required/>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center border bg-[#F4F8F7] rounded-lg">
                ...
                <input type="password" id="contraseña" placeholder="Contraseña" className=" bg-[#F4F8F7] w-full px-3 py-2 border-0 focus:outline-none" required/>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="flex items-center border bg-[#F4F8F7] rounded-lg">
                ...
                <input type="password" id="contraseña" placeholder="Repetir Contraseña" className=" bg-[#F4F8F7] w-full px-3 py-2 border-0 focus:outline-none" required />
              </div>
            </div>
            ...
            <div className="flex justify-center">
              ...
              <Link to="/candidatos" className="w-[150px] bg-[#4F43B1] text-center  text-[#FFFFFF] p-4 rounded-[40px] hover:bg-blue-600 transition duration-300" >
                  Registrarse
              </Link>
