      ...
      <div className="text-center mt-6">
        {step === 1 && (
          <>
            <p className="text-xl font-semibold mb-4">
              ¿Cómo planeas utilizar ConnectTalent?
            </p>
            <p className="text-lg text-gray-700">
              Elige la opción para la cual te creas este perfil
            </p>
          </>
        )}
        {step === 2 && (
          <>
            ...
            <p className="text-lg text-gray-700">
              Optimizaremos su experiencia de configuracion segun sus
              preferencias
            </p>
          </>
        )}
        {step === 3 && (
          <>
            ...
            <p className="text-lg text-gray-700">
              Elige las tecnologias que mejor se adapten a tus habilidades
            </p>
          </>
        )}
      ...
      <div className="flex space-x-6 mt-6">
        {step === 1 && (
          <>
            <Link
              to="/innovadores"
              className="bg-white pl-6 pt-8 pb-8 rounded-lg shadow-lg w-64 cursor-pointer"
            >
              <FaLightbulb className="text-yellow-500 text-4xl mb-4" />
              <h2 className="text-xl font-bold mb-2">Innovadores</h2>
              <p className="text-gray-600">
                Comparte tus innovaciones tecnológicas y encuentra a los
                candidatos ideales
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-gray-600">
                Destaca tus habilidades postulando a proyectos innovadores
              </p>
            </div>
          </>
        )}
          ...
          <>
            <div className="bg-gradient-to-br  to-white p-6 space-y-6">
              <div className="flex flex-col items-center">
                <Link
                  to="/homecandidato"
                  className="w-[500px] p-2 text-center rounded-[5px] bg-[#4F43B1] max-w-md  text-white"
                  onClick={goToNextStep}
                >
                  Iniciar
                </Link>
