...
export default function Home() {
    ...
    const goToProfile = (pageName) => {
        navigate("/profile", { state: { activePage: pageName } }); // Redirige y pasa el estado
    };
        ...
        <div className="flex flex-col min-h-screen bg-[#5145C6]">
            ...
            <nav className="flex justify-between items-center px-8 py-4">
                ...
                <div className="space-x-8">
                    ...
                    <a href="/about" className="btn-links">Proyectos</a>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-lg ">
                    ...
                    {/* Menú desplegable */}
      {isMenuOpen && (
        <div className="absolute right-[55px] top-[70px] mt-2 w-48 bg-white rounded-lg shadow-lg">
          <ul className="py-2">
            <li className="px-4 py-2 text-gray-800 hover:bg-gray-100" onClick={() => goToProfile("Perfil")} >Perfil</li>
            <li className="px-4 py-2 text-gray-800 hover:bg-gray-100"   >Configuraciones</li>
            <li className="px-4 py-2 text-gray-800 hover:bg-gray-100">Cerrar sesión</li>
          </ul>
        </div>
      )}
                ...
                <div className="text-center">
                    ...
                    <div className='flex items-center justify-center space-x-4 m-4'>
                        <button onClick={handleModalToggle} 
                            className="w-[280px] px-4 py-2 font-bold text-[#3C137B] text-[20px] rounded-md bg-white border rounded-[10px] border-gray-300">
                            <span>Encuentra tu proyecto</span>
                        </button>
                    ...
                    {/* Modal */}
                    {isModalOpen && (
                        <ModalCategoria handleModalToggle={handleModalToggle} />
                    )}
            ...
            <div className="flex items-center justify-center w-full my-8">
                ...
                <span className="px-4 text-[#FFFFFF] font-semibold text-[20px]">ConnectTalent</span>
        ...
        <div className='flex flex-col bg-[#5145c6]'>
            <div className='flex justify-around items-center px-8 py-4'>
                <span className='font-bold text-[30px] text-[#FFFFFF]'>Proyectos Destacados</span>
                <p className='text-[#FFFFFF] text-[18px]'>"Descubre una amplia variedad de proyectos <br></br>
                    en los que puedes participar según tu talento."</p>
                <a className='btn-todos'>Ver Todos</a>
            </div>
            {/* imagenes */}
            <div className="relative w-full max-w-[1350px] mx-auto p-4 overflow-hidden flex items-center">
                <button
                    onClick={prevSlide}
                ...
                >
                    {projects.map((project) => (
                        <div  key={project.id} className="w-1/3 flex-shrink-0 p-2 relative">
                            <img
                                src={project.src}
                                alt={project.alt}
        ...
        <div className="flex justify-center space-x-8 p-8 bg-white text-center">
            {stats.map((stat, index) => (
                <div key={index} className="flex flex-col items-center">
                    ...
                    <h3 className="text-[20px] font-medium text-gray-600">{stat.title}</h3>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            <div className={`text-6xl ${testimonial.quoteColor}  top-4 left-4 leading-none`}>
                                <FaQuoteLeft />
                            </div>
        ...
        <div className="flex flex-col items-center justify-center p-10 flex-grow space-y-7">
            <span className="text-[40px] text-[#5145C6]">¿Listo para comenzar tu próximo proyecto?</span>
