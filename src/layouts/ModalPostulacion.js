                    ...
                    {step === 3 && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">
                                    ¿Cuántos años de experiencia tienes con Flutter y/o React Native?<span className="text-destructive">*</span>
                                    </label>
                                </div>
                                <input 
                                    placeholder=""
                            ...
                            <div className="space-y-2">
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">
                                    ¿Qué nivel de experiencia tienes integrando APIs RESTful?<span className="text-destructive">*</span>
                                    </label>
                                </div>
                                <input 
                                    placeholder=""
                            ...
                            <div className="space-y-2">
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">
                                    ¿Cuál es tu nivel de familiaridad con patrones de diseño de aplicaciones móviles?<span className="text-destructive">*</span>
                                    </label>
                                </div>
                                <input 
                                    placeholder=""
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium">
                                    ¿Cuál es tu nivel de Español?<span className="text-destructive">*</span>
                                </label>
                                <select
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-medium">
                                    ¿Cuál es tu nivel de Ingles?<span className="text-destructive">*</span>
                                </label>
                                <select
                                    value={selectedOption}
                                    className="block w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div className="space-y-2">
                                <div className="space-y-2">
                                    <label className="text-sm font-medium">
                                    ¿Cuál es tu pretensión salarial?*<span className="text-destructive">*</span>
                                    </label>
                                </div>
                                <input 
                                    placeholder=""
